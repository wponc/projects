...
function Project(props) {
  return(
    <div className="Project">
      ...
      <img loading="lazy" src={props.src} alt={props.alt} className="imageGallery" />
    </div>
  )
}